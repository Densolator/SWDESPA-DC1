...
public class CalendarProgram
{
    ...
    String[] months =  {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
        ...
        {			
			...
			System.out.println("The month today is:" +  month);
			for(CalendarEvent event: events)
			{
				System.out.println("The month for the event is: " + (event.getMonth() - 1));
        ...
        {
        	calendarTable.setBackground(Color.GREEN);
        }
	...
	public CalendarProgram()
		...
		TableCellRenderer cell = calendarTable.getCellRenderer(2, 3);
